    ...
    public class InsurancePaperController : Controller
    {
        ...
        public IActionResult DashBoardView()
        {
            List<Employee> dashboardcompleted = _dbcontext.Employees.Include(i => i.InsurancePapers)
             ...
             .Where(e => e.InsurancePapers.Q1Insurances != null || e.InsurancePapers.Q6Insurances != null  || e.InsurancePapers.EmploymentContract != null )
             .Where(e=> e.InsurancePapers.Q1Insurances != "Not Found"&& e.InsurancePapers.Q6Insurances != "Not Found" && e.InsurancePapers.EmploymentContract != "Not Found").ToList();

            List<Employee> dashboardUncompleted = _dbcontext.Employees.Include(i => i.InsurancePapers)
                .Include(i => i.Department)
                .Where(e => e.InsurancePapers.Q1Insurances == null || e.InsurancePapers.Q1Insurances == "Not Found" || e.InsurancePapers.Q6Insurances == null || e.InsurancePapers.Q6Insurances == "Not Found" || e.InsurancePapers.EmploymentContract == null || e.InsurancePapers.EmploymentContract == "Not Found").ToList();
